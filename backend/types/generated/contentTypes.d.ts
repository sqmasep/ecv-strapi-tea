...
export interface ApiTeaTypeTeaType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tea-type.tea-type'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    teas: Schema.Attribute.Relation<'manyToMany', 'api::tea.tea'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeaTea extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tea_types: Schema.Attribute.Relation<
      'manyToMany',
      'api::tea-type.tea-type'
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    favorites: Schema.Attribute.Relation<'manyToMany', 'api::tea.tea'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tea-type.tea-type': ApiTeaTypeTeaType;
